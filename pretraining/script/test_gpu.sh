#!/bin/bash
#SBATCH    -o ../slurm/0423_save_step/0423-mul2.5-b8-16000.log --gres=gpu:1 -p sugon 
...
#task=vgae_mse
# task=vgae_mse_concated_arga-cnn5.5-b8
task=vgae_mse_concated_arga-mul2.5-b8e3-0418
# task=vgae_mse_concated_arga-mul2.5-b8e3
...
model_path=../multinews_model/$task/model_auto_encoder_step_16000.pt
#model_path=../cnn_new_models/$task/model_auto_encoder_step_90000.pt
echo $model_path
...
python -u /home/LAB/src_gae/run.py -batch_size 3 \
    -data_path ../multinews_importance_result/multinews -mode test_ae \
    -embedding_path  /home/LAB/projects/AutoEncoder/gignore/glove/glove.840B.300d.txt -num_gpus 0 -local_rank 0 \
