...
python gen_graph.py -input_path ../nyt/nyt_pre_result -save_path ../nyt/nyt_graph_result -block_size  5 -file_id 3 -test_file_num 0
...
# python get_importance_index.py -input_path cnn_graph/ -save_path /home/LAB/mid_results -block_size  10 -file_id 0 -test_file_num 0