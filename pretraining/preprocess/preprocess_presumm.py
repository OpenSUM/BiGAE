...
if __name__ == '__main__':
    ...
    parser.add_argument("-map_path", default='/home/LAB/projects/data/')
    parser.add_argument("-raw_path", default='/home/LAB/projects/line_data')
    ...
    parser.add_argument("-embedding_path", default='/home/LAB/projects/AutoEncoder/gignore/glove/glove.840B.300d.txt')
    ...
    eval('data_builder.'+args.mode + '(args)') #mode是format_to_bert
